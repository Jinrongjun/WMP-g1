...
class AMPLoader:
    ...
    def __init__(
            ...
            selected_joint_indices=list(range(29))  # 新增参数：你想要保留的关节索引列表
            ):
    ...
    def feed_forward_generator(self, num_mini_batch, mini_batch_size):
        ...
        for _ in range(num_mini_batch):
            if self.preload_transitions:
                ...
                # s = torch.cat([
                #     s,
                #     self.preloaded_s[idxs, self.JOINT_POS_START_IDX: ]], dim=-1)
    ...
    def observation_dim(self):
        ...
        return self.extended_traj[0].shape[1] # Joint positions 